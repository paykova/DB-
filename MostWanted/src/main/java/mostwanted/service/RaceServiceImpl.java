...
public class RaceServiceImpl implements RaceService {
    ...
    @Autowired
    public RaceServiceImpl(RaceRepository raceRepository, FileUtil fileUtil, DistrictRepository districtRepository, RaceEntryRepository raceEntryRepository, ModelMapper modelMapper, ValidationUtil validationUtil, XmlParser xmlParser) {
...
//        }
        ...
        Arrays.stream(raceImportRootDto.getRaceImportDtos()).forEach(raceImportDto -> {
            ...
            importResult.append(String.format(Constants.SUCCESSFUL_IMPORT_MESSAGE, race.getClass().getSimpleName(), race.getId()))
