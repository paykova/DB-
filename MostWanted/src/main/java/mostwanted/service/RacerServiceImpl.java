...
public class RacerServiceImpl implements RacerService {
    ...
    @Autowired
    public RacerServiceImpl(RacerRepository racerRepository, ModelMapper modelMapper, ValidationUtil validationUtil, TownRepository townRepository, FileUtil fileUtil, Gson gson) {
